...
replace tailscale.com => github.com/LiuTangLei/tailcat-tailscale v1.102.4-tailcat.1

replace github.com/quic-go/quic-go => github.com/LiuTangLei/tailcat-quic-go v0.62.0-tailcat.4
