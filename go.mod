...
replace tailscale.com => github.com/LiuTangLei/tailscale v1.102.3-tailcat.2

replace github.com/quic-go/quic-go => github.com/LiuTangLei/quic-go v0.62.0-tailcat.2
