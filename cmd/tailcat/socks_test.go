...
func TestClassifySOCKSAddr(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:   "addr_host",
			addr:   "tch3pWF2AWFwWCAAAQIAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAH2FrWCAHAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAGFxWCAJAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAGFpCg:8081",
			lookup: noLookup,
			want: socksTarget{
				addr: "tch3pWF2AWFwWCAAAQIAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAH2FrWCAHAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAGFxWCAJAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAGFpCg",
				port: 8081,
			},
		},
		{
